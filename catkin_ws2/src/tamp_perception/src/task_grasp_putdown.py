...
# -----------------------------------------
# object_loc, object_orien = demo.get_model_pose('box_red')
object_loc, object_orien = demo.get_model_pose('utensil_nerf_bowl')
# object_loc, object_orien = demo.get_model_pose('box_green')
...
# -----------------------------------------
# move to a position for putting down
# -----------------------------------------
demo.navigate_to_position(place_loc, place_orien)
print('move to a position for putting down is done!')
print('-'*30)

# -----------------------------------------
# compute pose for putting down & reach goal
# -----------------------------------------
pose_goal = demo.compute_pose_for_putdown(place_ee_loc)
demo.plan_pose_goal(pose_goal)
print('compute pose for putting down & reach goal is done!')
print('-'*30)
